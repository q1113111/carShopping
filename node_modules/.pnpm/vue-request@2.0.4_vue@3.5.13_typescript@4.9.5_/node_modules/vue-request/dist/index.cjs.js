...
function usePagination(service) {
  ...
  const pageSize = vueDemi.computed({
    get: () => {
  ...
  const totalPage = vueDemi.computed(() => get(data.value, totalPageKey, Math.ceil(total.value / pageSize.value)));
  return {
    data,
    params,
    current,
